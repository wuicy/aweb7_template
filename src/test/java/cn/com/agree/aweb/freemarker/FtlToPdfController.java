...
public class FtlToPdfController {
  ...
  @ApiOperation(value = "", notes = "swagger接口返回的下载文件中文名称会有乱码问题，浏览器则不会")
  public void byTemplate(@RequestParam(required = false) String name, @RequestParam(required = false) String desc,
